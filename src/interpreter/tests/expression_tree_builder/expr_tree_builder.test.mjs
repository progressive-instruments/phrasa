...
describe("expression tree builder", function() {
  it('general', function () {
    ...
    expect(expression.subjects[0].value).toEqual('key');
    ...
    expect(expression.subjects[0].value).toEqual('key2');
    expect(expression.expressions[0].type).toEqual(PhrasaExpressionType.Value);
    ...
    expect(expression.subjects[0].value).toEqual('keyobj');
    ...
    expect(innerexpression.subjects[0].value).toEqual('objkey');
    ...
    expect(innerexpression.subjects[0].value).toEqual('objobjkey');
    expect(innerexpression.expressions[0].type).toEqual(PhrasaExpressionType.Value);
    ...
    expect(innerexpression.subjects[0].value).toEqual('objkey2');
    expect(innerexpression.expressions[0].type).toEqual(PhrasaExpressionType.Value);
